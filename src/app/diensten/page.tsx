...
export default function ServicesPage() {
  return <PublicPageLayout breadcrumbs={[{ label: 'Home', href: '/' }, { label: 'Diensten' }]} eyebrow="Diensten" title="Welke ondersteuning past bij uw vraag?" description="Bekijk veelvoorkomende arbo- en veiligheidsdiensten. Begin bij uw situatie; u hoeft vooraf nog geen specialist te kiezen."><Section spacing="compact"><ServiceOverviewList items={serviceOverview} /></Section><PublicContentPathways contentId="overview:services" /></PublicPageLayout>
}
