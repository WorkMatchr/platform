...
export const metadata: Metadata = { title: 'Opdracht aangemaakt | WorkMatchr' }
...
export default async function AssignmentCreatedPage({ params }: { params: Promise<{ assignmentId: string }> }) {
  ...
  return (
      <Section spacing="compact" containerSize="narrow">
        <Heading as="h1" size="h2">Uw opdracht is aangemaakt</Heading>
        <p className="mt-3 max-w-2xl text-text-secondary">
          Uw opdrachtgegevens zijn bewaard. U kunt de opdracht nu bekijken en verder voorbereiden.
        </p>
        <Card className="mt-8">
          ...
          <p className="mt-5 text-sm font-semibold text-text-secondary">Opdracht</p>
          ...
          <p className="mt-5 rounded-control bg-success/10 p-4 text-success">Uw oorspronkelijke hulpvraag en antwoorden zijn veilig bewaard.</p>
        </Card>
