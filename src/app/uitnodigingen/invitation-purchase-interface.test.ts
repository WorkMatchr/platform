...
describe('opdracht kopen-interface', () => {
  it('communiceert prijs, directe afschrijving en de volledige weergave na aankoop', () => {
    ...
    expect(page).toContain('Opdracht kopen — {preview.priceCredits} credits')
  ...
  it('bepaalt preview en volledige toegang in de server-query', () => {
    ...
    expect(query).toContain('fullAssignment: hasFullAccess ? { ...invitation.assignment, id: externalAssignmentId(invitation.assignment) } : null')
  })
})
