...
const EXPECTED_BRANCH = 'codex/financial-invoice-pdf-email'
...
function hasExpectedRuntime(): boolean {
...
export async function POST(request: Request) {
  if (!hasExpectedRuntime() || !isAuthorized(request)) return new Response(null, { status: 404 })
