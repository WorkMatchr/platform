  ...
  return (
    <ArboGuidePageLayout title="Krijg richting bij uw arbo- en veiligheidsvraag" description="Onze Arbo-wijzers helpen u stap voor stap bepalen wat aandacht vraagt en welke ondersteuning passend kan zijn.">
      <div className="grid gap-6 md:grid-cols-2">
        <ArboGuideOverviewCard title="Advieswijzer" description="Kies zelf een deskundigheid of, als u die nog niet weet, het onderwerp van uw vraag. Beschrijf uw vraag en publiceer uw opdracht." href={publicRoutes.adviceGuide} actionLabel="Start de Advieswijzer" />
