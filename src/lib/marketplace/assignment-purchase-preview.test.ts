...
describe('AssignmentPreview', () => {
  it('laat uitsluitend de gecontroleerde basisinformatie door', () => {
    const preview = toAssignmentPreview({
      id: 'assignment-1', title: 'Onderzoek naar fysieke belasting', primarySpecialism: { name: 'Ergonoom' },
    ...
    expect(preview).toMatchObject({ expertise: 'Ergonoom', region: 'Utrecht', priceCredits: 27, maximumPurchasers: 3 })
