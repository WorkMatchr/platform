...
export const compatibilityContextGoals = Object.freeze([
  {
    ...
    relevantConceptCodes: [], satisfiesFactCodes: ['SECTOR'], equivalentGoalCodes: [], mandatory: true, universal: true,
  ...
  },
  {
    ...
    relevantConceptCodes: ['RIE'], satisfiesFactCodes: ['RIE_INTENT'], equivalentGoalCodes: [], mandatory: true, universal: false,
  ...
  },
  {
    ...
    relevantConceptCodes: ['RIE'], satisfiesFactCodes: ['ORGANIZATION_SIZE'], equivalentGoalCodes: ['EMPLOYEE_PRESENCE'], mandatory: false, universal: true,
  ...
  },
  {
    ...
    relevantConceptCodes: ['RIE'], satisfiesFactCodes: ['WORKSITE_COUNT'], equivalentGoalCodes: [], mandatory: false, universal: true,
  ...
  },
  {
    ...
    relevantConceptCodes: ['RIE', 'EMERGENCY_RESPONSE'], satisfiesFactCodes: ['START_WINDOW'], equivalentGoalCodes: [], mandatory: false, universal: true,
  ...
  },
  {
    ...
    relevantConceptCodes: ['HEALTH_COMPLAINT', 'OCCUPATIONAL_HEALTH', 'INCIDENT', 'EXPOSURE'], satisfiesFactCodes: ['WORK_ACTIVITY'], equivalentGoalCodes: ['OCCUPATION'], mandatory: false, universal: true,
  ...
  },
  {
    ...
    relevantConceptCodes: ['HEALTH_COMPLAINT', 'EXPOSURE', 'WORK_ENVIRONMENT_CHANGE'], satisfiesFactCodes: ['LOCATION_PATTERN'], equivalentGoalCodes: ['WORK_LOCATION_PATTERN'], mandatory: false, universal: true,
  ...
  },
  {
    ...
    relevantConceptCodes: ['HEALTH_COMPLAINT', 'WORK_ENVIRONMENT_CHANGE'], satisfiesFactCodes: ['WORK_ENVIRONMENT_CHANGE'], equivalentGoalCodes: [], mandatory: false, universal: true,
  ...
  },
  {
    ...
    relevantConceptCodes: ['EXPOSURE', 'HAZARDOUS_SUBSTANCES'], satisfiesFactCodes: ['EXPOSURE_SOURCE'], equivalentGoalCodes: ['EQUIPMENT_OR_PROCESS'], mandatory: false, universal: false,
  ...
  },
  {
    ...
    relevantConceptCodes: ['PHYSICAL_LOAD'], satisfiesFactCodes: ['PHYSICAL_LOAD'], equivalentGoalCodes: [], mandatory: false, universal: false,
  ...
  },
  {
    ...
    relevantConceptCodes: ['HEALTH_COMPLAINT', 'RIE', 'INCIDENT', 'EXPOSURE'], satisfiesFactCodes: ['EXISTING_ASSESSMENT'], equivalentGoalCodes: [], mandatory: false, universal: true,
  ...
  },
  {
    ...
    relevantConceptCodes: ['HEALTH_COMPLAINT', 'EXPOSURE', 'INCIDENT'], satisfiesFactCodes: ['DURATION_FREQUENCY'], equivalentGoalCodes: [], mandatory: false, universal: true,
  ...
  },
  {
    ...
    relevantConceptCodes: ['INCIDENT', 'HAZARDOUS_SUBSTANCES', 'EMERGENCY_RESPONSE'], satisfiesFactCodes: ['URGENCY'], equivalentGoalCodes: [], mandatory: true, universal: true,
