...
const associations: Record<string, Associations> = {
  ...
  'service:middelbare-veiligheidskundige': { obligation: 'obligation:rie', sector: 'sector:industrie' },
  'service:arbeids-en-organisatiedeskundige': { knowledge: 'knowledge:psa', obligation: 'obligation:psa', sector: 'sector:onderwijs' },
  'service:ergonoom': { knowledge: 'knowledge:occupational-hygienist', obligation: 'obligation:rie', sector: 'sector:zorg' },
  'service:machineveiligheid': { obligation: 'obligation:rie', sector: 'sector:industrie' },
  'service:gevaarlijke-stoffen': { knowledge: 'knowledge:occupational-hygienist', obligation: 'obligation:rie', sector: 'sector:industrie' },
  'service:explosieveiligheid': { knowledge: 'knowledge:occupational-hygienist', obligation: 'obligation:rie', sector: 'sector:industrie' },
  'service:brandveiligheid': { knowledge: 'knowledge:bhv-capacity', obligation: 'obligation:bhv', sector: 'sector:onderwijs' },
  'service:geluidsdeskundige': { knowledge: 'knowledge:occupational-hygienist', obligation: 'obligation:rie', sector: 'sector:industrie' },
  'service:stralingsdeskundige': { knowledge: 'knowledge:occupational-hygienist', obligation: 'obligation:rie', sector: 'sector:zorg' },
  'service:arbeidspsycholoog': { knowledge: 'knowledge:psa', obligation: 'obligation:psa', sector: 'sector:zakelijke-dienstverlening' },
  'service:vertrouwenspersoon': { knowledge: 'knowledge:psa', obligation: 'obligation:psa', sector: 'sector:onderwijs' },
  'service:casemanager-verzuim': { knowledge: 'knowledge:occupational-physician', obligation: 'obligation:basiscontract', sector: 'sector:zorg' },
  'service:arbodienst': { knowledge: 'knowledge:occupational-physician', obligation: 'obligation:basiscontract', sector: 'sector:zakelijke-dienstverlening' },
  'service:keuringsinstantie': { obligation: 'obligation:rie', sector: 'sector:industrie' },
