...
11. **Module 7 — Nieuwe hulpvraag — M7A afgerond; M7B technisch opgeleverd met handmatige acceptatie open.** Werksets 7.1–7.3a, M7A.1 en M7A.2 leveren de veilige pseudonieme conceptintake, hervatting, append-only antwoordhistorie, deterministische vraagsturing, bewuste beëindiging, begripsbevestiging en laatste UX-polish. M7B voegt een deterministische Professional Advice-laag toe voor RI&E, incidenten, gevaarlijke stoffen, arbeidsgezondheid en BHV, inclusief onbevestigde `DRAFT`-vereisten en gecontroleerde kennis- en bronverwijzingen. Adviesdossieropslag, automatische timeout, retentie, definitieve indiening, accountkoppeling, omzetting naar `Intake`/`Assignment`, publicatie en matching zijn niet gestart.
