...
- **Module 6B / Contract tenantcontext — technisch geïmplementeerd; handmatige product-owneracceptatie open.** `OrganizationMembership.userId` is databasebreed uniek, de context is cookievrij en enkelvoudig en wissel-/toevoeg-UI is verwijderd. De migratie stopt fail-closed bij conflicten. Accountverwijdering, retentie, purge en volledige membershipbeëindiging blijven niet geïmplementeerd.
