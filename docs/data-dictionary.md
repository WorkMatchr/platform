...
| `FinancialJorttSync`, `FinancialJorttSyncAttempt` | Downstream boekhoudprojectie met Jortt remote ID, administratief factuurnummer, retry-status en immutable pogingen. | Het `WM-...`-nummer blijft de externe reference; een synchronisatiefout wijzigt kernrecords nooit. |
